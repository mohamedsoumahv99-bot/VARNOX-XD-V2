/**
 * VARNOX XD V2 — lib/botInstance.js  v3
 *
 * Corrections v3 :
 *  - Store par instance (createStore()) : les messages/contacts de chaque
 *    utilisateur sont isolés les uns des autres.
 *  - attachBotHandlers reçoit un store propre à chaque instance.
 *  - createBotInstance passe le bon store à getMessage.
 *
 * Deux usages :
 *
...
function attachBotHandlers(sock, sessionDir, ownerNumber, saveCreds) {
  ...
  // Ce listener ne doit être enregistré qu'une seule fois par socket.
