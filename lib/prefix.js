...
function readStore() {
    ...
    try {
        ...
        return {
            default: value.default || DEFAULT_PREFIX,
...
/**
 * Convertit le préfixe configuré en préfixe interne ".".
 * Le point reste accepté comme compatibilité afin qu'un changement de
 * préfixe ne bloque pas l'administration du bot.
 */
function normalizeCommandText(text, prefix = '.') {
