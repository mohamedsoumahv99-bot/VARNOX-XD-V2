 ...
 * Always fires — the .areact toggle only controls whether reactions are shown
 * for non-owner users. Owner always gets feedback.
...
async function addCommandReaction(sock, message, cmdKey) {
  try {
    ...
    // If disabled via .areact off, skip (owner can still re-enable)
